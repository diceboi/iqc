...
export default function Kispad20ft({ chairColor, interiorColor, containerColor }) {
  const group = useRef();
  const { scene, nodes } = useGLTF("/3D/kispad-20ft.gltf");
